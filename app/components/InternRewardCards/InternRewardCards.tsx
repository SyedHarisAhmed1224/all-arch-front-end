...
const InterRewardCards: React.FC<InterRewardCardsProps> = ({ cardInfo }) => {
    return (
        <div className={`transition duration-200 hover:-translate-y-1 bg-white w-50 h-45 rounded-2xl flex flex-col items-center justify-center border ${cardInfo.hasRedBorder ? 'border-(--custom-text-red)' : 'border-gray-300'}`}>
