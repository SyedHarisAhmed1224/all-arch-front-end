...
const AuthContainer: React.FC<AuthContainerProps> = ({ authType = 0, toggleAuth }) => {
    ...
    return (
        ...
        <>
            {
                showChoice &&
                <div className='w-fit md:w-150 h-fit bg-white rounded-3xl flex flex-col justify-between gap-5 overflow-hidden'>
                    <div className='w-full h-fit bg-(--lp-portal-info-bg-color) text-white flex flex-col items-center justify-center gap-0 md:gap-5 py-5 px-3'>
                    ...
                    <div className='flex flex-col items-center justify-center w-full h-fit px-5 md:px-10 py-4 md:py-8 gap-7'>
                        <div className='w-full h-fit flex flex-col md:flex-row items-center justify-between gap-9'>
                            <button onClick={() => { handleUserTypeChange(0) }}
                                ...
                                <span className='text-center text-[0.75rem] md:text-[0.9rem] opacity-70'>Learn research skills and earn while I grow</span>
                            </button>
                            ...
                            <button onClick={() => { handleUserTypeChange(1) }}
                                ...
                                <span className='text-center text-[0.75rem] md:text-[0.9rem] opacity-70'>Hire researchers to complete my project</span>
                            </button>
                        </div>
            ...
            {
                !showChoice &&
                <div className='w-full max-w-[95vw] md:w-150 h-fit bg-white rounded-3xl py-4 md:py-5 px-4 md:px-5 flex flex-col justify-between gap-5'>
                    ...
                    <div className='w-full px-5'>
                        <h2 className='text-(--custom-text-color) font-["lora"] text-[1.25rem] md:text-[1.5rem] font-semibold'>Join ALLARCH Academy</h2>
                    ...
                    <div className='h-full w-full overflow-y-auto'>
                        <div className='w-full h-10 flex items-center justify-center border-b border-b-gray-300'>
                            <div className='w-full md:w-[80%] h-full flex'>
