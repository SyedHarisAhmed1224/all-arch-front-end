    ...
    return (
        <div
            ...
            className='w-full h-full flex flex-col justify-center items-center gap-3 py-8'>
                <div className='text-white font-["lora"] text-[2rem]'>Research Services <span className='text-(--client-top-bar-text-color)'>Built For You</span></div>
                <div className='text-white opacity-50 w-[50%] text-center text-[0.95rem]'>
